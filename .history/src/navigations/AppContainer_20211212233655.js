...
import Dialog, { SlideAnimation, DialogButton, DialogContent } from 'react-native-popup-dialog';
import {
    StyleSheet,
    View,
    ActivityIndicator,
                ...
                <TouchableOpacity onPress={() => {
                    ...
                    >
                        <DialogContent style={{ flex: 1 }}>
                            ...
                            />
                            <Image style={styles.photo} source={{ uri: this.data.item.photo_url_two }} />
                            <Text style={styles.title}>{data.item.title}</Text>
                        </DialogContent>
                    </Dialog>
                </TouchableOpacity>
