...
export default function SearchScreen(props) {
  ...
  return (
    <View>
      <FlatList style={styles.flatList} vertical showsVerticalScrollIndicator={false} numColumns={0} key={'_'} data={data} renderItem={renderRecipes} keyExtractor={(item) => "_" + `${item.recipeId}`} />
    </View>
  );
}
